...
public class BlueClose24SidespikeV1 extends OpMode {
    ...
    private PathChain shootPreload, intakeFirst, shootFirst, intakeSecond, shootSecond, openGate, intakeGate1, shootGate1, intakeGate2, shootGate2, intakeGate3, shootGate3, intakeGate4, shootGate4, intakePile, strafePile, shootPile;
    ...
    public void buildPaths() {
        ...
        intakePile = follower.pathBuilder().addPath(
                ...
                ).setLinearHeadingInterpolation(Math.toRadians(-144), Math.toRadians(125))
                .build();

        strafePile = follower.pathBuilder().addPath(
                        new BezierLine(
                                new Pose(12.000, 34.000),
                                new Pose(12.000, 54.000)
                        )
...
//                .build();
        ...
        stateMachine = new StateMachine(
                ...
                new State()
                        .onEnter(() -> {
                            ...
                            follower.followPath(strafePile, true);
                        })
                        .transition(new Transition(() -> follower.atParametricEnd())),
                new State()
                        .onEnter(() -> {
    ...
    public void loop() {
        ...
        // ALSO TODO: update the azimuth+feedforward but not the hood angle/shooter velocity
        ...
        // now it applies feedforward but target is same
