...
public class SOTMUtil {
    ...
    public ShootingConstants.ShooterOutputs calculateShooterOutputsTele(Pose turretPose, Vector currentSpeeds, Vector robotAcceleration, double angularVelocity, double dt, Alliance alliance) {
