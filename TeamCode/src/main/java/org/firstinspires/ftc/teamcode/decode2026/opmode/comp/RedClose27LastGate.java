...
@Autonomous(name="Red Close 27 Last Gate", group="!")
public class RedClose27LastGate extends OpMode {
    ...
    private PathChain shootPreload, intakeFirst, shootFirst, intakeSecond, shootSecond, intakeGate1, shootGate1, intakeGate2, shootGate2, intakeGate3, shootGate3, intakeGate4, shootGate4, intakeGate5, shootGate5, intakeGate6, shootGate6, intakePile, shootPile, park;
    ...
    public void buildPaths() {
        ...
        intakeGate5 = follower.pathBuilder()
                .addPath(
                        new BezierLine(
                                Flipper.flip(new Pose(57.000, 77.000)),
                                new Pose(FieldConstants.RED_GATE_AUTO_POSE.getX(),FieldConstants.RED_GATE_AUTO_POSE.getY()-.4)
                        )
                )
                .setHeadingInterpolation(toGate)
                .setTValueConstraint(0.99)
...
//                        .maxTime(500),
                ...
                new State()
                        .onEnter(() -> {
                            ...
                            // follower.holdPoint(new BezierPoint(FieldConstants.RED_GATE_AUTO_POSE), FieldConstants.RED_GATE_AUTO_POSE.getHeading());
                        })
                        .minTime(600)
