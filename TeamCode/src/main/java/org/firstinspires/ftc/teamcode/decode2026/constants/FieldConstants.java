...
//                    16, 70
    ...
    public static Pose RED_GATE_AUTO_POSE_24 = new Pose(FIELD_WIDTH - BLUE_GATE_AUTO_POSE_27.getX()-2, BLUE_GATE_AUTO_POSE_27.getY() - 1, Flipper.flipAngle(BLUE_GATE_AUTO_POSE_27.getHeading()));
