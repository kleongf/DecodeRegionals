...
class ArtifactProcessorImpl extends ArtifactProcessor implements VisionProcessor
{
    private ColorRange purpleColorRange = ColorRange.ARTIFACT_PURPLE;
    private ColorRange greenColorRange = ColorRange.ARTIFACT_GREEN;
    ...
    ArtifactProcessorImpl(ImageRegion roiImg, ContourMode contourMode,
    ...
    public Object processFrame(Mat frame, long captureTimeNanos)
    {
        ...
        Core.inRange(roiMat_userColorSpace, new Scalar( 32, 135, 135),
                new Scalar(255, 155, 169), maskPurple);
