...
@Autonomous(name="Blue Far 30 pid to ball instant update", group="!")
public class BlueFar30Test extends OpMode {
    ...
    private PathChain intakeCorner, shootCorner, intakeThird, shootThird, shootPile1;
    ...
    public void init() {
        ...
        stateMachine = new StateMachine(
                ...
                new State()
                        ...
                        .maxTime(2000)
                        // transition when we pass x = 12 so that we keep moving to the target
                        .transition(new Transition(() -> follower.getPose().getX() < 12)),
                new State()
                        .onEnter(() -> {
    ...
    public void loop() {
        ...
        if (isTrackingBall) {
            ...
            Pose targetPose = new Pose(9, MathUtil.clamp(currentY + optimalX, 9, 40), Math.toRadians(180));
