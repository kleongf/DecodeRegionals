...
public class SOTMTuningTeleopBlue extends OpMode {
    ...
    public void loop() {
        ...
        telemetry.addData("target turret pos", teleop.robot.turret.wantedPositionTicks);
        telemetry.addData("turret error", teleop.robot.turret.wantedPositionTicks - teleop.robot.turret.currentPositionTicks);
