...
@Autonomous(name="Red Far 30/33 Vision + park", group="!")
public class RedFar30 extends OpMode {
    ...
    public void buildPaths() {
        ...
        intakeCorner = follower.pathBuilder()
                .addPath(new BezierLine(Flipper.flip(new Pose(50.000, 12.000)), Flipper.flip(new Pose(9, 8))))
        ...
        intakeGate = follower.pathBuilder()
                .addPath(
                        new BezierCurve(
                                Flipper.flip(new Pose(50.000, 16.000)),
                                Flipper.flip(new Pose(32.000, maxY)),
                                Flipper.flip(new Pose(10.000, maxY))
                        )
                )
                .setTangentHeadingInterpolation()
                .build();
        ...
        park = follower.pathBuilder()
                .addPath(
                        new BezierLine(Flipper.flip(new Pose(50, 16)), Flipper.flip(new Pose(48, 24)))
                )
                .setConstantHeadingInterpolation(Flipper.flipAngle(Math.toRadians(135)))
                .build();
                            ...
                            if (intakeY == -1) {
                                ...
                                currentIntakePath = follower.pathBuilder()
                                        .addPath(
                                                new BezierCurve(
                                                        follower.getPose(),
                                                        Flipper.flip(new Pose(28, intakeY)),
                                                        Flipper.flip(new Pose(10, intakeY))
                                                )
                                        )
                                        .setTangentHeadingInterpolation()
                                        .build();
